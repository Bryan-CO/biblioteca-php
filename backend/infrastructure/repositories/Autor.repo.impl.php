...
class AutorRepository implements IAutorRepository
{
  ...
  {
    return $this->dbClient->executeProcedure("editautor", TypeProcedure::FUNCTION, [$autor->getIdAutor(), $autor->getNombre()]);
  }
  public function delete($id)
  {
    $this->dbClient->executeProcedure("removeautor", TypeProcedure::CALL, [$id]);
  }
}
