...
class IdiomaRepository implements IIdiomaRepository
{
  ...
  {
    return $this->dbClient->executeProcedure("editidioma", TypeProcedure::FUNCTION, [$idioma->getIdIdioma(), $idioma->getNombre()]);
  }
  public function delete($id)
  {
    $this->dbClient->executeProcedure("removeidioma", TypeProcedure::CALL, [$id]);
  }
}
